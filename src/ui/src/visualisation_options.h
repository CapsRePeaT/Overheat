...
//should we have one object with list of options? It will lower number of signals and slots
class VisualisationOptionsWidget : public QWidget
{
 ...
 signals:
  void VisualisationOptionsChanged(const VisualisationOptions& visualisation_options);
