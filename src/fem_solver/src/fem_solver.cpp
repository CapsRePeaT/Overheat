...
void FemSolver::Solve(FileRepresentation& file_rep) {
	...
	// main_matrix.AddCoeficient(0, 0, 2); main_matrix.AddCoeficient(0, 1, 1);
	// main_matrix.AddCoeficient(0, 2, 1); main_matrix.AddCoeficient(1, 0, 1);
	// main_matrix.AddCoeficient(1, 1, -1); main_matrix.AddCoeficient(1, 2, 0);
	// main_matrix.AddCoeficient(2, 0, 3); main_matrix.AddCoeficient(2, 1, -1);
